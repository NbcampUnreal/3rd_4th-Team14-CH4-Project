...
namespace ITItemGameplayTags
{
	...
	/* Weapon Ability Cue */
	IMITATIONTRIGGER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Weapon_Hit_Player);
	IMITATIONTRIGGER_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayCue_Weapon_Hit_Others);
